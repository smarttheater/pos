...
const appRoutes = [
    ...
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | modules-error-error-module */ "modules-error-error-module").then(__webpack_require__.bind(null, /*! ./modules/error/error.module */ "./app/modules/error/error.module.ts")).then(m => m.ErrorModule)
    },
];
