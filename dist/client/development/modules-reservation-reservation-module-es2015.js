...
let ReservationDownloadComponent = class ReservationDownloadComponent {
    constructor(store, utilService, reservationService, downloadService, translate, localeService) {
        this.store = store;
...
let ReservationSearchComponent = class ReservationSearchComponent {
    constructor(store, modal, localeService, utilService, reservationService, translate) {
        this.store = store;
        this.modal = modal;
        this.localeService = localeService;
        this.utilService = utilService;
...
/* harmony import */ var _reservation_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./reservation-routing.module */ "./app/modules/reservation/reservation-routing.module.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
ReservationModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _components_pages_reservation_search_reservation_search_component__WEBPACK_IMPORTED_MODULE_5__["ReservationSearchComponent"],
        ...
        imports: [
            ...
            _reservation_routing_module__WEBPACK_IMPORTED_MODULE_6__["ReservationRoutingModule"],
