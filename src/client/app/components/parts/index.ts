...
export * from './purchase/cinema/purchase-cinema-schedule-work/purchase-cinema-schedule-work.component';
export * from './purchase/event/purchase-event-schedule-work/purchase-event-schedule-work.component';
